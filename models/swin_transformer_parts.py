...
class SwinTransformerV2(nn.Module):
    ...
    def __init__(self,
        ...
        patch_resolution: Tuple[int, int] = (input_resolution[0][0] // patch_size, input_resolution[1][1] // patch_size)
    ...
    def update_resolution(self, new_window_size: int, new_input_resolution: Tuple[int, int]) -> None:
        ...
        #print(new_input_resolution)
        new_patch_resolution: Tuple[int, int] = (new_input_resolution[0][0] // self.patch_size,
                                                  new_input_resolution[1][1] // self.patch_size)
