...
import torch
import copy
from models.pta_hybrid_model import PTAhybridModel
import monai
...
sweep_id = wandb.sweep(sweep=sweep_configuration, project = "sweep-pta-sam")
...
def main():
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):
        ...
        for i, data in enumerate(dataset):  # inner loop within one epoch
            ...
            if isinstance(model, PTAhybridModel) and total_iters > opt.structured_shape_iter:
